...
export default function Button({ children, className = '', variant = 'primary', ...props }: ButtonProps) {
  const variants = {
    ...
    outline: 'bg-transparent border border-honey-600 text-bee-black hover:bg-honey-100 font-medium py-3.5 px-8 rounded-xl transition-all duration-300 disabled:opacity-50'
  };
